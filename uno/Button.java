...
public class Button extends Actor
{
    ...
    public Button(int w, int h, String text, int textSize, Color textColor, int h_space, int v_space) {
        ...
        button.drawImage(new GreenfootImage(text, textSize, textColor, new Color(0, 0, 0, 0),new Color(181, 180, 180, 255)), h_space, v_space);
        setImage(button);
